(() => {
  ...
  const CART_KEY=`cantinho_petisco_cart_${MENU_MODE}_v3`;
  const SIZE_ORDER={P:1,M:2,G:3};
  const state={allCategories:[],categories:[],products:[],specials:[],cart:[],query:'',category:'all',selected:null,selectedQty:1,selectedVariants:[],specialOverride:null,groupMap:new Map()};
